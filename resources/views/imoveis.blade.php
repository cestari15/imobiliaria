...
@section('conteudo')
    ...
    <h1 class="text-warning casa" style="text-align: center">CASAS</h1>
    ...
    <h1 class="text-warning " style="text-align: center">APARTAMENTOS</h1>
    ...
    <h1 class="text-warning " style="text-align: center">SALÕES COMERCIAIS</h1>
    ...
    <h1 class="text-warning " style="text-align: center">TERRENOS</h1>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item">
                <a class="page-link" href="{{route('imoveis2')}}">Próximo</a>
            </li>
        </ul>
    </nav>
@endsection
