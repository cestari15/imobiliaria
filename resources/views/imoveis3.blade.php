...
<h1 class="text-warning casa" style="text-align: center">EM CONSTRUÇÃO</h1>
...
<nav aria-label="Page navigation example">
    <ul class="pagination justify-content-center">
        <li class="page-item ">
            <a class="page-link" href="{{route('imoveis2')}}">Anterior</a>
        </li>
        ...
        <li class="page-item">
            <a class="page-link disable" href="#">Próximo</a>
        </li>
    </ul>
</nav>
